...
namespace BHWeb.Areas.Customer.Controllers
{
    ...
    public class POSController : BaseController
    {
        ...
        public IActionResult IndexPOST()
        {
            ...
            {
                return RedirectToAction(nameof(Index), new { CustomerDetail = ShopCartVM.ShopCustomerId });
            }
            return RedirectToAction(nameof(Index));
        }
        ...
        public IActionResult PlaceOrder(string? NoPrint)
        {
            if (SaleOrderVM.SaleOrder == null)
            {
                ...
                else
                {
                    ...
                    {
                        _unitOfWork.AccountReceivable.accountReceivableUpdate(0, 0, shopCustomer.Id, _userId, applicationUser.ShopId, (double)ShopCartVM.ReceivedAmount);
            ...
            if (ShopCartVM.ShopCustomerId != null)
            {
                ...
                _unitOfWork.AccountReceivable.accountReceivableUpdate(SaleOrderVM.OrderTotal, SaleOrderVM.SaleOrder.Id, SaleOrderVM.SaleOrder.Customer.Id, _userId, applicationUser.ShopId, (double)ShopCartVM.ReceivedAmount);
            }
